    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Simple CRUD
                    <span class="h-20px border-1 border-gray-200 border-start ms-3 mx-2 me-1"></span>
                    <span class="text-muted fs-7 fw-bold mt-2">Modal Based</span>
                </h1>
            </div>
            <div class="d-flex align-items-center overflow-auto">
                ...
                <div class="d-flex justify-content-end" data-table-toolbar="base">
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#save_modal" onclick="resetForm()">
                    ...
                    <button id="simple_crud_refresh_btn" type="button" class="btn btn-sm btn-icon btn-light-dark ms-3" onclick="dt.ajax.reload()">
...
@section('content')
    <div class="card">
        <div class="card-body pt-0">
            <table id="simple_crud_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    <th class="w-10px pe-2">
                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                            <input class="form-check-input" type="checkbox" id="checkbox_id" data-kt-check="true"
                                   data-kt-check-target="#simple_crud_datatable .form-check-input" value="1"/>
                        </div>
                    </th>
    ...
    {{-- Save Modal --}}
    @include('developer.simple_crud.save')
@endsection
@section('style')

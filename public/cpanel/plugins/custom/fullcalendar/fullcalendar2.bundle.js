...
var FullCalendar = (function (e) {
  ...
  function y(e, t, n, r, i) {
    ...
    e: if ("style" === t)
      ...
      (s = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + s] = n),
        n
          ? r || e.addEventListener(t, s ? S : b, s)
          : e.removeEventListener(t, s ? S : b, s);
  ...
  function R(e) {
    ((!e.__d && (e.__d = !0) && s.push(e) && !A.__r++) ||
      o !== n.debounceRendering) &&
      ((o = n.debounceRendering) || D)(A);
  }
  function A() {
    var e, t, n, r, i, o, l, a;
    for (
    ...
    for (n.__k = [], h = 0; h < t.length; h++)
      if (
        ...
        if (
          ((v.__ = n),
          (v.__b = n.__b + 1),
          null === (p = E[h]) || (p && v.key == p.key && v.type === p.type))
        )
          E[h] = void 0;
        else
          for (f = 0; f < w; f++) {
  ...
  function T(e, t, n) {
    for (var r, i = e.__k, s = 0; i && s < i.length; s++)
      (r = i[s]) &&
        ((r.__ = e),
        (t =
          "function" == typeof r.type ? T(r, t, n) : k(n, r, r, i, r.__e, t)));
    return t;
  }
  function _(e, t) {
    return (
      ...
      e: if ("function" == typeof _) {
        if (
          ...
          null != _.getDerivedStateFromProps &&
            ...
            h(u.__s, _.getDerivedStateFromProps(b, u.__s))),
          (p = u.props),
          (g = u.state),
          (u.__v = t),
          f)
          ...
          if (
            ...
            (!u.__e &&
              ...
              !1 === u.shouldComponentUpdate(b, u.__s, C)) ||
              t.__v === r.__v)
          ) {
            for (
              t.__v !== r.__v &&
        ...
        (u.state = u.__s),
          ...
          f ||
            ...
            (v = u.getSnapshotBeforeUpdate(p, g)),
          (T =
  ...
  function N(e, n, r, i, s, o, l, a) {
    ...
    if (null === m) p === g || (a && e.data === g) || (e.data = g);
      ...
      if (
        ...
        (u = (p = r.props || c).dangerouslySetInnerHTML),
      ...
      if (
        ((function (e, t, n, r, i) {
          var s;
          for (s in n)
            "children" === s || "key" === s || s in t || y(e, s, null, n[s], r);
          for (s in t)
      ...
      a ||
        ("value" in g &&
          ...
          (v !== e.value ||
            ("progress" === m && !v) ||
            ("option" === m && v !== p.value)) &&
          y(e, "value", v, p.value, !1),
        "checked" in g &&
          void 0 !== (v = g.checked) &&
          v !== e.checked &&
          y(e, "checked", v, p.checked, !1));
    }
    return e;
  }
  function P(e, t, r) {
  ...
  function H(e, t, r) {
    ...
    if ((i = e.__k))
      for (s = 0; s < i.length; s++)
        i[s] && H(i[s], t, r || "function" != typeof e.type);
  ...
  let xe;
  "undefined" != typeof document && Re(document);
  function Te(e) {
  ...
  function Gt(e, t) {
    return Jt(e) === Jt(t) ? Math.round(Lt(e, t)) : null;
  }
  function Ft(e) {
  ...
  function nn(e) {
    return (
      rt(e.getUTCHours(), 2) +
      ":" +
      rt(e.getUTCMinutes(), 2) +
      ":" +
      rt(e.getUTCSeconds(), 2)
    );
  }
  function rn(e, t = !1) {
    let n = e < 0 ? "-" : "+",
  ...
  class mn {
    constructor(e) {
      ...
      for (let i in e)
        i in cn
          ? ((n[i] = e[i]), (r = Math.max(cn[i], r)))
          : ((t[i] = e[i]), i in dn && (r = Math.max(dn[i], r)));
      (this.standardDateProps = t),
        (this.extendedSettings = n),
        (this.severity = r),
        (this.buildFormattingFunc = sn(vn));
    }
    format(e, t) {
              ...
              (function (e, t, n, r, i) {
                ...
                !1 === r.meridiem
                  ...
                  : "lowercase" === r.meridiem &&
                    (e = e.replace(un, (e) => e.toLocaleLowerCase()));
  ...
  const Zn = {
    ...
    $n = Object.assign(Object.assign(Object.assign({}, Zn), Xn), {
      extendedProps: On,
    });
  ...
  function er(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Fn), $n),
  ...
  function ir(e) {
    let t = Math.floor(Lt(e.start, e.end)) || 1,
      n = Ft(e.start);
  ...
  function sr(e, t = dt(0)) {
    ...
    return (
      e.start && ((n = Ft(e.start)), r && r <= n && (r = Wt(n, 1))),
      { start: n, end: r }
    );
  }
  function or(e) {
  ...
  function lr(e, t, n, r) {
    return "year" === r
      ? dt(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? dt(n.diffWholeMonths(e, t), "month")
      : zt(e, t);
  }
  function ar(e, t) {
    return (
  ...
  function br(e, t) {
    let n,
      ...
      i = [],
      { start: s } = t;
    for (e.sort(Sr), n = 0; n < e.length; n += 1)
      (r = e[n]),
  ...
  function Mr(e, t, n = "day", r = !0) {
    ...
    if (s.navLinks) {
      ...
      return Object.assign(
        { title: it(s.navLinkHint, [l, e], l), "data-navlink": "" },
        r ? Ge(a) : { onClick: a }
      );
    }
    return { "aria-label": l };
  ...
  class Gr {
    ...
    similarTo(e) {
      return (
        Fr(this.tops || [], e.tops || []) &&
        Fr(this.bottoms || [], e.bottoms || []) &&
        Fr(this.lefts || [], e.lefts || []) &&
        Fr(this.rights || [], e.rights || [])
      );
    }
  }
  function Fr(e, t) {
  ...
  (Qr.prototype.classes = {}),
    (Qr.prototype.iconClasses = {}),
    (Qr.prototype.baseIconClass = ""),
    (Qr.prototype.iconOverridePrefix = "");
  class Xr extends E {
    render() {
      return p("div", {});
    }
  ...
  function ei(e, t, n, r, i, s, o, l, a, c, d, u, h) {
    return {
      ...
      createScrollResponder: (e) =>
        new Jr(e, c, dt(n.scrollTime), n.scrollTimeReset),
    ...
    shouldComponentUpdate(e, t) {
      return (
        ...
        !kt(this.props, e, this.propEquality) ||
          !kt(this.state, t, this.stateEquality)
      );
    }
    safeSetState(e) {
      kt(
  ...
  class oi {
    constructor(e) {
      (this.props = e),
        (this.nowDate = si(e.nowInput, e.dateEnv)),
        this.initHiddenDays();
    }
    buildPrev(e, t, n) {
    ...
    adjustActiveRange(e) {
      ...
      return (
        n &&
          (gt(r) < 0 && ((s = Ft(s)), (s = t.add(s, r))),
          gt(i) > 1 && ((o = Ft(o)), (o = Wt(o, -1)), (o = t.add(o, i)))),
        { start: s, end: o }
      );
    }
    buildRangeFromDuration(e, t, n, r) {
      ...
      return (
        gt(n) <= 1 &&
          this.isHiddenDay(i) &&
          ((i = this.skipHiddenDays(i, t)), (i = Ft(i))),
        c(),
    ...
    buildDateIncrement(e) {
      ...
      return (
        n || ((t = this.props.dateAlignment) ? dt(1, t) : e || dt({ days: 1 }))
      );
    }
    refineRange(e) {
      if (e) {
  ...
  function li(e, t, n) {
    n.emitter.trigger(
      "select",
      Object.assign(Object.assign({}, ai(e, n)), {
  ...
  function ci(e, t, n) {
    ...
    return (
      e
        ? ((s = Ft(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
  ...
  function hi(e, t, n, r, i) {
    ...
    return (
      ...
      l &&
        (a.range = {
          start: a.range.start,
          end: ci(t.allDay, a.range.start, i),
        }),
      t.allDay &&
        (a.range = { start: Ft(a.range.start), end: Ft(a.range.end) }),
      a.range.end < a.range.start &&
        (a.range.end = ci(t.allDay, a.range.start, i)),
      a
    );
  }
  class fi {
  ...
  class pi {
    ...
    setProp(e, t) {
      if (e in Xn)
        ...
        (t = Zn[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Fn) {
        let n = Fn[e](t);
        (n =
          "color" === e
    ...
    get source() {
      ...
      return e
        ? new fi(this._context, this._context.getCurrentData().eventSources[e])
        : null;
    }
    get start() {
  ...
  class Gi {
    ...
    offsetForMarker(e) {
      return "local" === this.timeZone
        ? -Qt(Zt(e)).getTimezoneOffset()
        : "UTC" === this.timeZone
        ? 0
        : this.namedTimeZoneImpl
        ? this.namedTimeZoneImpl.offsetForArray(Zt(e))
        : null;
    }
    toDate(e, t) {
      return "local" === this.timeZone
        ...
        ? new Date(
            e.valueOf() -
              1e3 * this.namedTimeZoneImpl.offsetForArray(Zt(e)) * 60
          )
  ...
  class Fi {
    ...
    splitEntry(e, t, n) {
      ...
      return (
        ...
        r
          ? (n.push(
              { index: e.index, thickness: e.thickness, span: Qi(o, s) },
              ...i
            ),
            r)
          : (n.push(e), 0)
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (Zi(r, t.level, t.levelCoord), Zi(n, t.level, [e]))
        : Zi(n[t.level], t.lateral, e),
    ...
    findInsertion(e) {
      ...
      let h = -1;
      return (
        u < s && t[u] === o && (h = Xi(n[u], e.span.end, Vi)[0]),
        {
          touchingLevel: l,
          touchingLateral: a,
          touchingEntry: c,
        ...
        r &&
          i(
            Object.assign(
              ...
              { elClasses: (n.elClasses || []).filter(us) }
            )
          );
      }
    }
          ...
          elAttrs: Object.assign(
            {
              role: "columnheader",
              colSpan: i.colSpan,
              "data-date": l.isDisabled ? void 0 : en(s),
            },
            i.extraDataAttrs
          ),
          renderProps: u,
  ...
  class ys extends E {
    constructor(e, t) {
      super(e, t),
        (this.initialNowDate = si(t.options.now, t.dateEnv)),
    ...
    computeTiming() {
      ...
      return (
        (s = Math.min(864e5, s)),
        {
          currentState: { nowDate: r, todayRange: bs(r) },
          nextState: { nowDate: i, todayRange: bs(i) },
          waitMs: s,
        }
      );
    }
  ...
  class Cs {
    ...
    getDateDayIndex(e) {
      let { indices: t } = this,
        n = Math.floor(Lt(this.dates[0], e));
  ...
  class Ds {
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(Pn(e, Rs(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
      ...
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, s) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (n = Pn(n, r, s)), zn(ks(e, t.sourceId), n);
          }
          return e;
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          let d =
              ...
              {
                defs: p.defs,
                instances: wt(p.instances, (e) => !g[e.instanceId]),
              }),
            u = d.defs,
            h = d.instances,
          ...
          for (let r in a) {
            ...
            for (let e in h) {
              ...
              if (wr(p, n.range)) {
                ...
                if (y && !y(new pi(t, u[n.defId], n), new pi(t, m, o)))
                  return !1;
              }
            }
            let b = i.eventStore;
            for (let e of g.allows) {
              let i,
                ...
                l = b.defs[m.defId],
                a = b.instances[r];
              if (((i = l ? new pi(t, l, a) : new pi(t, m)), !e(ai(s, t), i)))
                return !1;
            }
          }
          return !0;
...
//   }
    ...
    return p(
      ...
      e.timeText &&
        p(
          "div",
          {
            className: "create_ribbon", //ribbon ribbon-triangle ribbon-top-end custom-color
          },
          p(
            "div",
            {
              className: "ribbon-label mt-n4", // ribbon-icon
            },
            p(
              "p",
              {
                className: "create_text_status m-0 me-1",
              },"" //Paid
            ),
            p(
                "i",
      ...
      return p(
        ...
        Object.assign({}, e, {
          ...
          elAttrs: Object.assign(
            ...
            r.isDisabled ? {} : { "data-date": en(e.date) }
          ),
          renderProps: r,
  ...
  function Mo(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Fn), _o),
  ...
  class Io {
    ...
    today() {
      ...
      this.unselect(),
        this.dispatch({
          type: "CHANGE_DATE",
          dateMarker: si(e.calendarOptions.now, e.dateEnv),
        });
    }
    gotoDate(e) {
    ...
    select(e, t) {
      ...
      i &&
        (this.dispatch({ type: "SELECT_DATES", selection: i }), li(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
    ...
    addEvent(e, t) {
      if (e instanceof pi) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: Bn({ def: t, instance: n }),
            }),
      ...
      if (i) {
        ...
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Bn(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
  ...
  function qo(e) {
    ...
    return (
      t.content
        ? (n = Yo(t))
        : !n ||
          n.prototype instanceof ni ||
          (n = Yo(Object.assign(Object.assign({}, t), { content: n }))),
      { superType: t.type, component: n, rawOptions: t }
    );
  }
  function Yo(e) {
    return (t) =>
      p(Kr.Consumer, null, (n) =>
        p(fs, {
          elTag: "div",
          elClasses: To(n.viewSpec),
  ...
  function $o(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return tl(
          e,
          t.sourceIds ? Rt(t.sourceIds) : rl(e, r),
          i,
          t.isRefetch || !1,
          r
        );
  ...
  function Ko(e, t, n, r) {
    ...
    return n && (i = el(i, n, r)), Object.assign(Object.assign({}, e), i);
  }
  function el(e, t, n) {
    return tl(
      e,
      wt(e, (e) =>
        (function (e, t, n) {
          if (!il(e, n)) return !e.latestFetchId;
          return (
  ...
  function cl(e, t, n, r, i) {
    return {
      header: e.headerToolbar ? dl(e.headerToolbar, e, t, n, r, i) : null,
      footer: e.footerToolbar ? dl(e.footerToolbar, e, t, n, r, i) : null,
    };
  }
  ...
  const pl = [
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            zr(
              e.eventSource.meta.bind(null, Hi(e.range, r)),
              (e) => t({ rawEvents: e }),
              n
            );
          },
    ...
    Lo({
      name: "misc",
      isLoadingFuncs: [(e) => Jo(e.eventSources)],
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            Object.assign(Object.assign({}, Hi(e.activeRange, t.dateEnv)), {
              view: t.viewApi,
            })
          );
        },
  ...
  class gl {
    constructor(e, t) {
      (this.runTaskOption = e),
        ...
        (this.queue = []),
        (this.delayedRunner = new zs(this.drain.bind(this)));
    }
    request(e, t) {
  ...
  class vl {
    constructor(e) {
      (this.computeCurrentViewData = sn(this._computeCurrentViewData)),
        ...
        (this.buildPluginHooks = zo()),
        (this.buildDateEnv = sn(yl)),
        (this.buildTheme = sn(bl)),
        (this.parseToolbars = sn(cl)),
        (this.buildViewSpecs = sn(Qo)),
        (this.buildDateProfileGenerator = on(Sl)),
        (this.buildViewApi = sn(El)),
        (this.buildViewUiProps = on(Dl)),
        (this.buildEventUiBySource = sn(Cl, xt)),
        (this.buildEventUiBases = sn(wl)),
        (this.parseContextBusinessHours = on(Al)),
        (this.buildTitle = sn(ml)),
        (this.emitter = new Ur()),
        (this.actionRunner = new gl(
      ...
      let a = Xo(n.calendarOptions, o, l),
        c = {
      ...
      Rl(c, l) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
    ...
    _handleAction(e) {
      ...
      let u = $o(n.eventSources, e, d, a),
        ...
        v = {
          ...
          dateSelection: sl(n.dateSelection, e),
          eventSelection: ol(n.eventSelection, e),
          eventDrag: ll(n.eventDrag, e),
          eventResize: al(n.eventResize, e),
        },
      ...
      if (l && l !== a) {
        l.timeZone !== a.timeZone &&
          ((t.eventSources = s.eventSources =
            (function (e, t, n) {
              let r = t ? t.activeRange : null;
              return tl(e, rl(e, n), r, !0, n);
            })(s.eventSources, t.dateProfile, s)),
          (t.eventStore = s.eventStore =
            _s(s.eventStore, n.dateEnv, s.dateEnv)),
          (t.renderableEventStore = s.renderableEventStore =
            _s(s.renderableEventStore, n.dateEnv, s.dateEnv)));
        for (let e in o)
    ...
    processRawCalendarOptions(e, t) {
      let { locales: n, locale: r } = Mn([Dn, e, t]),
        ...
        l = this.buildPluginHooks(e.plugins || [], pl),
        a = (this.currentCalendarOptionsRefiners = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign({}, wn), Rn), An),
            l.listenerRefiners
          ),
          l.optionRefiners
        )),
      ...
      for (let e in d)
        ...
        (d[e] === h[e] || (xn[e] && e in h && xn[e](h[e], d[e])))
          ? (u[e] = f[e])
          : a[e]
          ? ((u[e] = a[e](d[e])), (p = !0))
          : (c[e] = h[e]);
      ...
      for (let e in s)
        s[e] === a[e] || (xn[e] && xn[e](s[e], a[e]))
          ...
          : (s[e] === this.currentCalendarOptionsInput[e] ||
            (xn[e] && xn[e](s[e], this.currentCalendarOptionsInput[e]))
        ...
        (this.handleSegClick = (e, t) => {
          ...
          if (i && n.isValidSegDownEl(e.target)) {
            ...
            r.emitter.trigger("eventClick", {
              el: t,
              event: new pi(n.context, i.eventRange.def, i.eventRange.instance),
              jsEvent: e,
              view: r.viewApi,
            }),
  ...
  class Il extends $i {
    ...
    triggerEvent(e, t, n) {
      ...
      (t && !r.isValidSegDownEl(t.target)) ||
        i.emitter.trigger(e, {
          el: n,
          event: new pi(i, s.eventRange.def, s.eventRange.instance),
          jsEvent: t,
          view: i.viewApi,
        });
    }
  ...
  class Ol extends ti {
    constructor() {
      super(...arguments),
        ...
        (this.buildViewPropTransformers = sn(Pl)),
        (this.buildToolbarProps = sn(Nl)),
  ...
  function Hl(e) {
    ...
    return new Gi(
      Object.assign(
        Object.assign({ timeZone: Dn.timeZone, calendarSystem: "gregory" }, e),
        { locale: t }
      )
    );
  }
  ...
  class Ll {
    constructor(e) {
      (this.subjectEl = null),
        ...
        (Bl += 1),
        1 === Bl && window.addEventListener("touchmove", zl, { passive: !1 });
    }
    destroy() {
      this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
        ...
        (Bl -= 1),
        Bl || window.removeEventListener("touchmove", zl, { passive: !1 });
    }
    tryStart(e) {
    ...
    shouldIgnoreMouse() {
      return Wl || this.isTouchDragging;
    }
    cancelTouchScroll() {
      this.isDragging && (jl = !0);
    }
    initScrollWatch(e) {
  ...
  class Ul {
    ...
    cleanup() {
      this.mirrorEl && (Te(this.mirrorEl), (this.mirrorEl = null)),
        (this.sourceEl = null);
    }
    updateElPosition() {
      this.sourceEl &&
  ...
  const ql = "function" == typeof performance ? performance.now : Date.now;
  class Yl {
    constructor() {
      (this.isEnabled = !0),
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(ql()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Zl {
    constructor(e) {
      (this.origRect = jr(e)),
        (this.scrollCaches = Lr(e).map((e) => new Fl(e, !0)));
    }
    destroy() {
      for (let e of this.scrollCaches) e.destroy();
    }
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!Xl(e.getEventTarget()) && !ar(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function Xl(e) {
  ...
  class ea extends $i {
    constructor(e) {
          ...
          if (e) {
            ...
            i === s || (t.editable && t.droppable)
              ? ((o = (function (e, t, n) {
                ...
                o &&
                  ((l = di(n, s.getCurrentData().eventUiBases, o, s)),
                  (c.mutatedEvents = l),
            ...
            if (
              ...
              if (r === t) {
                ...
                r.emitter.trigger("eventAdd", p),
                  ...
                  r.emitter.trigger(
                    "drop",
                    Object.assign(Object.assign({}, Kl(d.dateSpan, r)), {
                      draggedEl: e.subjectEl,
                      jsEvent: e.origEvent,
      ...
      let { component: t } = this,
        { options: n } = t.context,
        r = (this.dragging = new Ql(e.el));
      (r.pointer.selector = ea.SELECTOR),
        (r.touchScrollAllowed = !1),
        (r.autoScroller.isEnabled = n.dragScroll);
      let i = (this.hitDragging = new $l(this.dragging, Ki));
  ...
  ea.SELECTOR = ".fc-event-draggable, .fc-event-resizable";
  const ta = { fixedMirrorParent: On },
    na = {
      dateClick: On,
      eventDragStart: On,
      eventDragStop: On,
  ...
  class ra {
    constructor(e, t) {
        ...
        (this.handleDragEnd = (e) => {
          ...
          if ((this.clearDrag(), t && n)) {
            ...
            if (
              (t.emitter.trigger(
                "drop",
                Object.assign(Object.assign({}, Kl(r.dateSpan, t)), {
                  draggedEl: e.subjectEl,
                  jsEvent: e.origEvent,
                  view: i,
                })
      ...
      let n = (this.hitDragging = new $l(e, Ki));
      (n.requireInitial = !1),
    ...
    canDropElOnCalendar(e, t) {
      ...
      return "function" == typeof n
        ...
        : "string" != typeof n || !n || Boolean(ke(e, n));
    }
  }
  ts.dataAttrPrefix = "";
  class ia extends es {
          ...
          super(e),
            ...
            (this.handleDragEnd = (e) => {
              ...
              if (!n.wasTouchScroll) {
                ...
                if (n && r && Jl(n, r)) {
                  let { context: r } = t,
                    i = Object.assign(Object.assign({}, Kl(n.dateSpan, r)), {
                      dayEl: n.dayEl,
                      jsEvent: e.origEvent,
            ...
            (this.dragging = new Ql(e.el)),
            (this.dragging.autoScroller.isEnabled = !1);
          let t = (this.hitDragging = new $l(this.dragging, Ji(e)));
          t.emitter.on("pointerdown", this.handlePointerDown),
      ...
      class extends $i {
        constructor(e) {
          super(e),
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (li(this.dragSelection, e, this.component.context),
                (this.dragSelection = null));
            });
          let { component: t } = e,
            { options: n } = t.context,
          ...
          (r.touchScrollAllowed = !1),
            ...
            (r.autoScroller.isEnabled = n.dragScroll);
          let i = (this.hitDragging = new $l(this.dragging, Ji(e)));
          i.emitter.on("pointerdown", this.handlePointerDown),
            i.emitter.on("dragstart", this.handleDragStart),
            i.emitter.on("hitupdate", this.handleHitUpdate),
            i.emitter.on("pointerup", this.handlePointerUp);
        ...
        constructor(e) {
          super(e),
            ...
            (this.handleHitUpdate = (e, t, n) => {
              ...
              l &&
                ((a = di(i, r.getCurrentData().eventUiBases, l, r)),
                (d.mutatedEvents = a),
              ...
              if (
                ...
                t.emitter.trigger(
                  ...
                  Object.assign(Object.assign({}, a), {
                    el: this.draggingSegEl,
                    startDelta: this.validMutation.startDelta || dt(0),
                    endDelta: this.validMutation.endDelta || dt(0),
                    jsEvent: e.origEvent,
                    view: t.viewApi,
                  })
                ),
    ...
    calendarInteractions: [
      class {
        constructor(e) {
          (this.context = e),
            ...
            (this.onDocumentPointerDown = (e) => {
              ...
              (this.matchesCancel = !!_e(n, t)),
                (this.matchesEvent = !!_e(n, ea.SELECTOR));
            }),
          ...
          let t = (this.documentPointer = new Ll(document));
  ...
  class ha extends ni {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r } = e,
        i = Ti(r, n.eventTimeFormat || ca, t, !0, e.defaultDisplayEventEnd);
      return p(
        so,
        Object.assign({}, e, {
          elTag: "a",
  ...
  class pa extends ni {
    constructor() {
      super(...arguments), (this.compileSegs = sn(ga));
    }
    render() {
      let { props: e } = this,
            ...
            !l.isDisabled && (t.showDayNumber || ho(i) || t.forceDayTop)
              ? p(
                  ...
                  p(s, {
                    ...
                    elAttrs: Object.assign(Object.assign({}, Mr(e, o)), {
                      id: n.dayNumberId,
                    }),
                  })
                )
            ...
            (d += r.levelCoord - c),
              ...
              s
                ? ((d += r.thickness),
                  o &&
                    u.push({
                      seg: Sa(i, r.span.start, r.span.end, n),
                      isVisible: !0,
                      isAbsolute: !0,
                      absoluteTop: r.levelCoord,
                      marginTop: 0,
  ...
  class Ca extends ii {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        { options: r } = n,
        i = e.cells.length,
        s = la(e.businessHourSegs, i),
        o = la(e.bgEventSegs, i),
        l = la(this.getHighlightSegs(), i),
        a = la(this.getMirrorSegs(), i),
        {
    ...
    renderFgSegs(e, t, n, r, i, s, o) {
      ...
      if (c)
        for (let f of t) {
          ...
          y &&
            (l.isRtl
              ? ((S = 0), (b = c.lefts[t.lastCol] - c.lefts[t.firstCol]))
              : ((b = 0), (S = c.rights[t.firstCol] - c.rights[t.lastCol]))),
            h.push(
              p(
                "div",
                {
        ...
        for (let o of e) {
          ...
          s.push(
            p(
              ...
              "bg-event" === t
                ? p(po, Object.assign({ seg: o }, _i(o, r)))
                : mo(t)
            )
          );
        }
        ...
        if (e) {
          ...
          if (e.length) {
            ...
            (n.framePositions && n.framePositions.similarTo(r)) ||
              this.setState({ framePositions: new Gr(t, e, !0, !1) });
          }
        }
  ...
  Ca.addStateEquality({ eventInstanceHeights: xt });
  class wa extends ii {
    constructor() {
      super(...arguments),
        (this.splitBusinessHourSegs = sn(oa)),
        (this.splitBgEventSegs = sn(oa)),
        (this.splitFgEventSegs = sn(oa)),
        (this.splitDateSelectionSegs = sn(oa)),
        (this.splitEventDrag = sn(aa)),
        (this.splitEventResize = sn(aa)),
        (this.rowRefs = new Fs());
    }
    render() {
      let { props: e, context: t } = this,
      ...
      if (this.needsScrollReset && this.props.clientWidth) {
        const e = (function (e, t) {
          ...
          t.currentRangeUnit.match(/year|month/) &&
            (n = e.querySelector(`[data-date="${tn(t.currentDate)}-01"]`));
      ...
      let { dateEnv: r, options: i, viewApi: s } = n,
        o =
          null == i.slotLabelFormat
            ...
            ? Cn(i.slotLabelFormat[0])
            : Cn(i.slotLabelFormat),
        l = {
          level: 0,
          time: e.time,
  ...
  class Wa extends ni {
    render() {
      return this.props.slatMetas.map((e) =>
        p("tr", { key: e.key }, p(Pa, Object.assign({}, e)))
      );
    }
  }
  const Ba = Cn({ week: "short" });
  class ja extends ii {
    constructor() {
      super(...arguments),
        (this.allDaySplitter = new Oa()),
        ...
        (this.renderHeadAxis = (e, t = "") => {
          let { options: n } = this.context,
            ...
            i = r.renderRange,
            s =
              1 === Lt(i.start, i.end) ? Mr(this.context, i.start, "week") : {};
    ...
    safeComputeTop(e) {
      ...
      if (Rr(t.currentRange, e)) {
        ...
        if (r >= yt(t.slotMinTime) && r < yt(t.slotMaxTime))
          return this.computeTimeTop(dt(r));
      }
      return null;
    }
    computeDateTop(e, t) {
      return (
        t || (t = Ft(e)), this.computeTimeTop(dt(e.valueOf() - t.valueOf()))
      );
    }
    computeTimeTop(e) {
      let t,
    ...
    render() {
      ...
      return p(
        Eo,
        {
          ...
          dateProfile: e.dateProfile,
          todayRange: e.todayRange,
          popoverContent: () => rc(e.hiddenSegs, e),
          defaultGenerator: Ya,
          forceTimed: !0,
        },
        (e) =>
  ...
  function Za(e, t) {
    ...
    return o.sort(Xa), [o.map($a), o[0][1]];
  }
  function Xa(e, t) {
    return t[1] - e[1];
  }
  ...
  const ec = Cn({ hour: "numeric", minute: "2-digit", meridiem: !1 });
  class tc extends ni {
    render() {
      return p(
        oo,
  ...
  class nc extends ni {
    ...
    renderPositionedFgSegs(e, t, n, r, i, s) {
      let {
        ...
        { segPlacements: b, hiddenGroups: S } = (function (e, t, n, r) {
          ...
          let { segRects: o, hiddenGroups: l } = Qa(i, n, r),
            a = [];
      ...
      return p(
        ...
        b.map((e) => {
          let { seg: o, rect: a } = e,
            ...
            d = v || Boolean(!t[c] && a),
            u = ic(a && a.span),
            m = !v && a ? this.computeSegHStyle(a) : { left: 0, right: 0 },
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = Ka(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
          (r, i) => {
            let s = e[i];
            return p(
              "div",
              ...
              "bg-event" === t
                ? p(
                    po,
                    Object.assign({ seg: s }, _i(s, n.todayRange, n.nowDate))
                  )
                : mo(t)
            );
          }
  ...
  class sc extends ni {
    constructor() {
      super(...arguments),
        (this.splitFgEventSegs = sn(Fa)),
        (this.splitBgEventSegs = sn(Fa)),
        (this.splitBusinessHourSegs = sn(Fa)),
        (this.splitNowIndicatorSegs = sn(Fa)),
        (this.splitDateSelectionSegs = sn(Fa)),
        (this.splitEventDrag = sn(Va)),
        (this.splitEventResize = sn(Va)),
        (this.rootElRef = { current: null }),
        (this.cellElRefs = new Fs());
    }
    render() {
  ...
  function hc(e, t, n, r, i) {
    let s = new Date(0),
      ...
      a =
        ...
        (function (e) {
          let t, n, r;
          for (t = uc.length - 1; t >= 0; t -= 1)
            if (((n = dt(uc[t])), (r = bt(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
    ...
    views: {
      timeGrid: {
        component: class extends ja {
          constructor() {
            super(...arguments),
              (this.buildTimeColsModel = sn(fc)),
              (this.buildSlatMetas = sn(hc));
          }
          render() {
            let {
                options: e,
        ...
        u = Object.assign(
          {
            ...
            text: c,
            sideText: d,
            navLinkAttrs: Mr(this.context, s),
            sideNavLinkAttrs: Mr(this.context, s, "day", !1),
          },
          a
        );
      return p(
  ...
  const vc = Cn({ hour: "numeric", minute: "2-digit", meridiem: "short" });
  class yc extends ni {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r, timeHeaderId: i, eventHeaderId: s, dateHeaderId: o } = e,
        l = n.eventTimeFormat || vc;
      return p(
        so,
        Object.assign({}, e, {
          elTag: "tr",
  ...
  var wc = Lo({
    ...
    optionRefiners: {
      listDayFormat: Cc,
      listDaySideFormat: Cc,
      noEventsClassNames: On,
      noEventsContent: On,
      noEventsDidMount: On,
      noEventsWillUnmount: On,
    },
    views: {
      list: {
              ...
              for (let n = 0; n < l.length; n += 1) {
                ...
                if (d) {
                  let l = en(t[n]),
                    u = o + "-" + l;
                  c.push(
                    p(gc, { key: l, cellId: u, dayDate: t[n], todayRange: a })
                  ),
                    (d = wi(d, r.eventOrder));
                  for (let t of d)
                    c.push(
  ...
  const xc = Cn({ year: "numeric", month: "long" }),
    Tc = Cn({ month: "long" });
  function _c(e, t) {
    return (
      e ||
    ...
    views: {
      multiMonth: {
        component: class extends ii {
          constructor() {
            super(...arguments),
              (this.splitDateProfileByMonth = sn(Ac)),
              (this.buildMonthFormat = sn(_c)),
          ...
          componentDidUpdate(e) {
            xt(e, this.props) || this.handleSizing(!1),
              e.dateProfile !== this.props.dateProfile
                ? this.requestScrollReset()
                : this.flushScrollReset();
          }
  ...
  var Nc = Lo({
    ...
    optionRefiners: { schedulerLicenseKey: "0256010375-fcs-1685962253" },
    viewContainerAppends: [
      function (e) {
        ...
        //   let n = (function (e, t) {
        //     if (-1 !== Ic.indexOf(e)) return "valid";
        ...
        //     return p(
        //       "div",
        //       { className: "fc-license-message", style: Oc },
        //       "outdated" === n
        //         ? p(
        //             m,
        //             null,
      ...
      let { scrollEl: t, isRtl: n } = this,
        r = (function (e) {
          let t = e.getBoundingClientRect(),
            n = Wr(e);
          return {
            left: t.left + n.borderLeft + n.scrollbarLeft - Pc(e),
  ...
  class Lc extends ni {
    ...
    componentDidUpdate(e, t, n) {
      ...
      if ((xt(e, r) || this.handleSizing(), void 0 !== n.simulateScrollLeft))
  ...
  class Uc {
    constructor(e) {
      (this.el = e),
        ...
        (this.wheelWaiter = new zs(this._handleWheelWaited.bind(this))),
        (this.scrollWaiter = new zs(this._handleScrollWaited.bind(this))),
        (this.handleScroll = () => {
          this.startScroll(),
  ...
  class Gc {
    ...
    forceScrollLeft(e) {
      this.isPaused = !0;
      for (let t of this.scrollListeners) Hc(t.el, e);
      this.isPaused = !1;
    }
    forceScrollTop(e) {
      this.isPaused = !0;
  ...
  class Fc extends ni {
    constructor() {
      super(...arguments),
        (this.compileColGroupStats = ln(Qc, $c)),
      ...
      return p(
        ...
        (function (e, t) {
          let n = e.map((e, n) => {
            let r = e.width;
            return (
              "shrink" === r && (r = e.totalColWidth + $s(t[n]) + 1),
              p("col", { style: { width: r } })
            );
          });
          return p("colgroup", {}, ...n);
    ...
    componentDidMount() {
      (this.getStickyScrolling = ln(ed)),
        (this.getScrollSyncersBySection = an(Jc.bind(this, !0), null, Kc)),
        (this.getScrollSyncersByColumn = an(Jc.bind(this, !1), null, Kc)),
    ...
    allowSizing() {
      ...
      return !this.lastSizingDate ||
        e.valueOf() >
          this.lastSizingDate.valueOf() + ts.SCROLLGRID_RESIZE_INTERVAL
      ...
      for (let i = 0; i < t; i += 1) {
        ...
        if (t && t.syncRowHeights) {
          ...
          if (l) {
            ...
            let e = [];
            for (let t = 0; t < n; t += 1) e.push(Vc(r[t]) + r[t].length);
            let t = Math.max(...e);
            for (let e = 0; e < n; e += 1) {
              let n = r[e].length,
                i = t - n,
    ...
    destroyScrollSyncers() {
      Dt(this.scrollSyncersBySection, Kc), Dt(this.scrollSyncersByColumn, Kc);
    }
  ...
  function qc(e) {
    let t = Me(e, ".fc-scrollgrid-sync-inner").map(Yc);
  ...
  function Qc(e) {
    let t = Zc(e.cols, "width"),
      n = Zc(e.cols, "minWidth"),
      r = Js(e.cols);
    return {
      hasShrinkCol: r,
      totalColWidth: t,
  ...
  let nd = [],
    rd = [];
  function id() {
    for (let e of nd) e.emitter.trigger("_beforeprint");
    Zr(() => {
      rd.push(
        (function () {
          let e = Me(document.body, ".fc-scrollgrid");
          return e.forEach(od), () => e.forEach(ld);
        })()
      );
    });
  }
  function sd() {
    for (let e of nd) e.emitter.trigger("_afterprint");
    Zr(() => {
      for (; rd.length; ) rd.shift()();
    });
  }
  function od(e) {
    let t = e.getBoundingClientRect().width;
    (!e.classList.contains("fc-scrollgrid-collapsible") ||
      t < ts.COLLAPSIBLE_WIDTH_THRESHOLD) &&
      (e.style.width = t + "px");
  }
  function ld(e) {
    e.style.width = "";
  ...
  var ad = Lo({
    ...
    contextInit: function (e) {
      nd.length ||
        (window.addEventListener("beforeprint", id),
        window.addEventListener("afterprint", sd)),
        nd.push(e),
        e.calendarApi.on("_unmount", () => {
          Ot(nd, e),
            nd.length ||
              (window.removeEventListener("beforeprint", id),
              window.removeEventListener("afterprint", sd));
        });
    },
  });
  ...
  function dd(e, t, n, r) {
            ...
            switch (l) {
              ...
              case "millisecond":
                (c = {
                  ...
                  (i = (e) => "." + rt(e.millisecond, 3));
            }
            return [].concat(c || [], i || [], s || []);
          })(i, e, t, n);
    (i.headerFormats = o.map((e) => Cn(e))),
    ...
    (i.largeUnit = l),
      (i.emphasizeWeeks =
        1 === ht(i.slotDuration) && pd("weeks", e, t) >= 2 && !n.businessHours);
    let a,
      c,
      d = n.snapDuration;
    d && ((a = dt(d)), (c = bt(i.slotDuration, a))),
      null == c && ((a = i.slotDuration), (c = 1)),
      (i.snapDuration = a),
      (i.snapsPerSlot = c);
    let u = yt(e.slotMaxTime) - yt(e.slotMinTime),
      h = ud(e.renderRange.start, i, t),
      f = ud(e.renderRange.end, i, t);
    i.isTimeScale &&
      ((h = t.add(h, e.slotMinTime)), (f = t.add(Wt(f, -1), e.slotMaxTime))),
      (i.timeWindowMs = u),
      (i.normalizedRange = { start: h, end: f });
    let p = [],
      g = h;
    for (; g < f; ) hd(g, i, e, r) && p.push(g), (g = t.add(g, i.slotDuration));
    i.slotDates = p;
    let m = -1,
      v = 0;
    const y = [],
      b = [];
    for (g = h; g < f; )
      hd(g, i, e, r) ? ((m += 1), y.push(m), b.push(v)) : y.push(m + 0.5),
      ...
      (i.cellRows = (function (e, t) {
        ...
        for (let s = 0; s < n.length; s += 1) {
          ...
          for (let n = 0; n < r.length; n += 1) {
            ...
            if (f) {
              let e = t.format(a, s);
              u && u.text === e ? (u.colspan += 1) : (p = gd(a, e, g));
            } else if (
              !u ||
              ot(
  ...
  class md extends ni {
    constructor() {
      super(...arguments),
        (this.refineRenderProps = on(bd)),
        (this.buildCellNavLinkAttrs = sn(vd));
    }
    render() {
      let { props: e, context: t } = this,
      ...
      return p(
        fs,
        {
          ...
          elClasses: [
            ...
            ...("time" === i.rowUnit ? Tr(l, t.theme) : xr(l, t.theme)),
          ],
          elAttrs: {
            colSpan: i.colspan,
  ...
  class Ed {
    constructor(e, t, n, r, i, s) {
      (this.slatRootEl = e),
        ...
        (this.dateEnv = i),
        (this.isRtl = s),
        (this.outerCoordCache = new Gr(e, t, !0, !1)),
        (this.innerCoordCache = new Gr(e, Ie(t, "div"), !0, !1));
    }
    isDateInRange(e) {
    ...
    computeDateSnapCoverage(e) {
      return Cd(e, this.tDateProfile, this.dateEnv);
    }
  }
  function Cd(e, t, n) {
            ...
            p(
              ...
              r &&
                ...
                p(ao, {
                  ...
                  elStyle: wd(r.dateToCoord(n), t.isRtl),
                  isAxis: !0,
                  date: n,
                })
            )
      ...
      let { todayRange: r, nowDate: i } = this.props,
        ...
        l = e.map((e, t) => {
          ...
          return p(
            ...
            "bg-event" === n
              ? p(po, Object.assign({ seg: e }, _i(e, r, i)))
              : mo(n)
          );
        });
      return p(m, null, l);
  ...
  class Md extends Ds {
    sliceRange(e, t, n, r, i) {
      let s = (function (e, t, n) {
        ...
        o = [];
      if (Cd(s.start, r, i) < Cd(s.end, r, i)) {
        ...
        e &&
          o.push({
            ...
            isStart:
              e.start.valueOf() === s.start.valueOf() && hd(e.start, r, t, n),
            isEnd:
              e.end.valueOf() === s.end.valueOf() && hd(Bt(e.end, -1), r, t, n),
          });
      }
      return o;
    }
  ...
  class Pd extends ni {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        ...
        c = _d(a, r.eventMinWidth, e.timelineCoords),
    ...
    updateSize() {
      ...
      e.onHeightChange && e.onHeightChange(n, !1),
        t &&
          this.setState(
            {
              eventInstanceHeights: Dt(this.harnessElRefs.currentMap, (e) =>
                Math.round(e.getBoundingClientRect().height)
              ),
              moreLinkHeights: Dt(this.moreElRefs.currentMap, (e) =>
                Math.round(e.getBoundingClientRect().height)
              ),
            },
            () => {
  ...
  Pd.addStateEquality({ eventInstanceHeights: xt, moreLinkHeights: xt });
  class Hd extends ii {
    constructor() {
      super(...arguments),
            ...
            r.nowIndicator &&
              ...
              p(
                ...
                p(ao, {
                  ...
                  elStyle: wd(t.coords.dateToCoord(o), n.isRtl),
                  isAxis: !1,
                  date: o,
                })
              )
    ...
    views: {
      timeline: {
        component: class extends ii {
          constructor() {
            super(...arguments),
              (this.buildTimelineDateProfile = sn(dd)),
          ...
          render() {
            let { props: e, state: t, context: n } = this,
              ...
              { slotMinWidth: l } = r,
              a = Wd(o, l || this.computeFallbackSlotMinWidth(o)),
              c = [
                {
                  type: "header",
                  key: "header",
            ...
            return (
              s &&
                c.push({
                  ...
                  key: "footer",
                  isSticky: !0,
                  chunks: [{ key: "timeline", content: to }],
                }),
              p(
                xo,
                {
  ...
  function Ld(e, t = "", n, r) {
    ...
    if (
      ...
      for (let e of i.children) Ld(e, o.id, n, r);
    return o;
  }
  function zd(e) {
  ...
  class Ud {
    ...
    getParent() {
      ...
      return t ? new Ud(e, e.getCurrentData().resourceStore[t]) : null;
    }
    getChildren() {
      let e = this._resource.id,
        ...
        r = [];
      for (let i in n) n[i].parentId === e && r.push(new Ud(t, n[i]));
      return r;
    }
    getEvents() {
      let e = this._resource.id,
  ...
  function Gd(e) {
    return { resource: new Ud(e.context, e.resource) };
  }
  const Fd = Ke("id,title");
  class Vd extends ni {
    constructor() {
      super(...arguments), (this.refineRenderProps = on(Yd));
    }
    render() {
      const { props: e } = this;
        ...
        return p(
          ...
          Object.assign({}, e, {
            elAttrs: Object.assign(Object.assign({}, e.elAttrs), {
              ...
              "data-date": e.date ? en(e.date) : void 0,
            }),
            renderProps: r,
  ...
  function Yd(e) {
    return {
      resource: new Ud(e.context, e.resource),
  ...
  class Zd extends ni {
    constructor() {
      super(...arguments), (this.buildDateFormat = sn(Xd));
    }
    render() {
      let { props: e, context: t } = this,
    ...
    renderResourceRow(e, t) {
      let n = e.map((e) =>
        p(Qd, { key: e.id, resource: e, colSpan: 1, date: t })
      );
    ...
    renderResourceAndDayRows(e, t, n, r) {
      ...
      for (let o of e) {
        i.push(
          p(Qd, { key: o.id, resource: o, colSpan: t.length, isSticky: !0 })
        );
    ...
    renderDateCell(e, t, n, r, i, s) {
      let { props: o } = this,
        l = i ? ":" + i.id : "",
        a = i ? { resource: new Ud(this.context, i) } : {},
    ...
    buildTr(e, t) {
      ...
      return (
        e.length || (e = [p("td", { key: 0 }, " ")]),
        p("tr", { key: t, role: "row" }, n && n(t), e)
      );
    }
  }
  function Xd(e, t, n) {
    ...
    buildCells() {
      ...
      for (let i = 0; i < e; i += 1) {
        ...
        for (let r = 0; r < t.colCnt; r += 1)
          for (let s = 0; s < n.length; s += 1) {
            let o = n[s],
              l = { resource: new Ud(this.context, o) },
    ...
    joinProps(e, t) {
      ...
      for (let t of c) {
        ...
        n.push(c.dateSelectionSegs),
          r.push(t ? c.businessHourSegs : tu),
          i.push(t ? c.fgEventSegs : tu),
  ...
  function iu(e, t) {
    return su(e, [], t, !1, {}, !0).map((e) => e.resource);
  }
      ...
      (function e(t, n, r, i, s, o, l) {
        ...
        (function (e, t, n, r) {
          let i = (function (e, t) {
              ...
              for (let t in e) {
                let r = e[t];
                n[t] = { resource: r, resourceFields: au(r), children: [] };
              }
              for (let r in e) {
                let i = e[r];
                if (i.parentId) {
                  let e = n[i.parentId];
                  e && lu(n[r], e.children, t);
                }
              }
              return n;
            })(e, r),
          ...
          for (let e in i) {
            let o = i[e];
            o.resource.parentId || ou(o, s, n, 0, t, r);
          }
          return s;
        })(e, r ? -1 : 1, t, n),
        o,
      ...
      case "CHANGE_VIEW_TYPE":
        return (function (e, t, n, r) {
          if (
            n &&
            !(function (e) {
              return Boolean(mu(e.sourceDefId).ignoreRange);
            })(e) &&
  ...
  function Eu(e, t, n, r) {
    if (e) {
      let i = bu(e);
      return (i = Cu(i, n ? t : null, r)), i;
    }
    return null;
  }
  function Cu(e, t, n) {
    let r = mu(e.sourceDefId),
      i = qe();
    return (
      r.fetch(
  ...
  const Du = { resourceId: String, resourceIds: On, resourceEditable: Boolean };
  function Ru(e, t) {
    return Object.assign(Object.assign({}, t), {
      constraints: Au(e, t.constraints),
    });
  }
  function Au(e, t) {
    return t.map((t) => {
  ...
  (Io.prototype.addResource = function (e, t = !0) {
    ...
    (Io.prototype.getResources = function () {
      let e = this.getCurrentData(),
        { resourceStore: t } = e,
        n = [];
      if (t) for (let r in t) n.push(new Ud(e, t[r]));
      return n;
    }),
    (Io.prototype.getTopLevelResources = function () {
      let e = this.getCurrentData(),
        { resourceStore: t } = e,
        n = [];
      if (t) for (let r in t) t[r].parentId || n.push(new Ud(e, t[r]));
      return n;
    }),
      ...
      fetch(e, t, n) {
        const r = e.context.dateEnv,
          ...
          s = e.range
            ...
            : {};
        zr(i.bind(null, s), (e) => t({ rawResources: e }), n);
      },
    }),
    gu({
      parseMeta: (e) =>
  ...
  var ku = Lo({
    ...
    reducers: [
      function (e, t, n) {
        let r = Su(e && e.resourceSource, t, n);
        return {
          resourceSource: r,
    ...
    viewPropsTransformers: [
      ...
      class {
        constructor() {
          (this.buildResourceEventUis = sn(hu, xt)),
            (this.injectResourceEventUis = sn(fu));
        }
        transform(e, t) {
          return t.viewSpec.optionDefaults.needsResourceData
            ? null
        ...
        if (
          (e &&
            ...
            (r = Object.assign(Object.assign({}, r), {
              eventStore: zn(n[""].eventStore, r.eventStore),
              eventUiBases: Object.assign(
                Object.assign({}, n[""].eventUiBases),
                r.eventUiBases
              ),
            })),
          !Ns(r, t, { resourceId: e }, Ru.bind(null, e)))
        )
          return !1;
      }
      return !0;
      ...
      resourceStore: function (e, t) {
        ...
        n.hasHandlers("resourcesSet") &&
          n.trigger(
            ...
            (function (e, t) {
              let n = [];
              for (let r in e) n.push(new Ud(t, e[r]));
              return n;
            })(e, t)
          );
      },
  ...
  class Iu extends ii {
    ...
    render() {
      ...
      this.slicers = Dt(s, (e, t) => this.slicers[t] || new Aa());
      let o = Dt(this.slicers, (e, o) =>
  ...
  function Ou(e, t, n, r, i) {
    let s = Ma(e, t);
    return r ? new eu(s, n, i) : new Kd(s, n, i);
  }
  var Nu = Lo({
    ...
    views: {
      resourceDayGrid: {
        ...
        component: class extends ka {
          constructor() {
            super(...arguments),
              (this.flattenResources = sn(iu)),
              (this.buildResourceDayTableModel = sn(Ou)),
              (this.headerRef = { current: null }),
              (this.tableRef = { current: null });
          }
          render() {
  ...
  class Hu extends ii {
    ...
    render() {
      ...
      this.slicers = Dt(l, (e, t) => this.slicers[t] || new ac());
      ...
      resourceTimeGrid: {
        ...
        component: class extends ja {
          constructor() {
            super(...arguments),
              (this.flattenResources = sn(iu)),
              (this.buildResourceTimeColsModel = sn(Wu)),
              (this.buildSlatMetas = sn(hc));
          }
          render() {
            let { props: e, context: t } = this,
  ...
  function ju({ depth: e, hasChildren: t, isExpanded: n, onExpanderClick: r }) {
    let i = [];
    ...
    render() {
      ...
      return p(
        ...
        e.colSpecs.map((s, o) => {
          ...
          return l > 1
            ? p(Gu, { key: o, colSpec: s, fieldValue: a, rowSpan: l })
            : p(Lu, {
                key: o,
                colSpec: s,
                resource: t,
  ...
  Vu.addPropsEquality({ rowSpans: Nt });
  class qu extends ni {
    constructor() {
      super(...arguments),
  ...
  class Qu extends ni {
    constructor() {
      super(...arguments),
        (this.resizerElRefs = new Fs(this._handleColResizerEl.bind(this))),
        (this.colDraggings = {});
    }
    render() {
      let {
  ...
  class Zu extends ni {
    constructor() {
      super(...arguments),
        (this.refineRenderProps = on(Gd)),
        (this.handleHeightChange = (e, t) => {
          this.props.onHeightChange &&
            this.props.onHeightChange(_e(e, "tr"), t);
        });
    }
    render() {
      let { props: e, context: t } = this,
  ...
  class Ku extends ii {
    constructor() {
      super(...arguments),
        (this.computeHasResourceBusinessHours = sn(eh)),
        (this.resourceSplitter = new cu()),
        (this.bgSlicer = new Md()),
        (this.slatsRef = { current: null }),
        (this.state = { slatCoords: null }),
        (this.handleEl = (e) => {
          e
          ...
          p(
            ...
            n.options.nowIndicator &&
              ...
              p(
                ...
                p(ao, {
                  elClasses: ["fc-timeline-now-indicator-line"],
                  elStyle: wd(d.dateToCoord(t), n.isRtl),
                  isAxis: !1,
                  date: t,
                })
              )
  ...
  class nh extends ni {
    constructor(e, t) {
      super(e, t),
        (this.processColOptions = sn(oh)),
        (this.buildTimelineDateProfile = sn(dd)),
        (this.hasNesting = sn(sh)),
        (this.buildRowNodes = sn(su)),
        (this.layoutRef = { current: null }),
        (this.rowNodes = []),
        (this.renderedRowNodes = []),
        (this.buildRowIndex = sn(rh)),
        (this.handleSlatCoords = (e) => {
          this.setState({ slatCoords: e });
        }),
        (this.handleRowCoords = (e) => {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        ...
        { slotMinWidth: h } = r,
        f = Wd(d, h || this.computeFallbackSlotMinWidth(d));
      return p(
        xo,
        {
          elClasses: [
        ...
        p(th, {
          ...
          forPrint: e.forPrint,
          isHeightAuto: e.isHeightAuto,
          spreadsheetCols: ih(c, t.spreadsheetColWidths, ""),
          ...
          spreadsheetBodyRows: (e) =>
            p(m, null, this.renderSpreadsheetRows(u, c, e.rowSyncHeights)),
          timeCols: f,
          timeHeaderContent: (n) =>
            p(Rd, {
              clientWidth: n.clientWidth,
  ...
  nh.addStateEquality({ spreadsheetColWidths: Nt });
  var lh = Lo({
  ...
  return (
    pl.push(sa, Ia, pc, wc, Mc, td, ad, Bd, ku, Nu, Bu, lh),
    (e.Calendar = class extends Io {
      constructor(e, t = {}) {
        super(),
          ...
          (function (e) {
            e.isConnected && Re(e.getRootNode());
          })(e),
          (this.el = e),
          (this.renderRunner = new zs(this.handleRenderRequest)),
          new vl({
            optionOverrides: t,
            calendarApi: this,
    ...
    (e.Draggable = class {
      constructor(e, t = {}) {
        (this.handlePointerDown = (e) => {
          ...
          (t.minDistance =
            null != n ? n : e.isTouch ? 0 : Dn.eventDragMinDistance),
            (t.delay = e.isTouch ? (null != r ? r : Dn.longPressDelay) : 0);
        }),
          (this.handleDragStart = (e) => {
            e.isTouch &&
              this.dragging.delay &&

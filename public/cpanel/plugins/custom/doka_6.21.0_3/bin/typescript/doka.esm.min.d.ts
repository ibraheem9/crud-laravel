...
type UtilNames = "crop" | "filter" | "color" | "markup" | "resize" | "sticker";
...
type MarkupShapeItem = [MarkupType, MarkupShape];
...
interface StickerItem {
    sticker: string|MarkupShapeItem,
    markup?: string|MarkupShapeItem
}

type Sticker = string|MarkupShapeItem|StickerItem
...
interface IDokaOptions {
    ...
    beforeAddMarkup?: (blob: Blob) => boolean|MarkupShapeOption;
    beforeRemoveMarkup?: (blob: Blob) => boolean|MarkupShapeOption;
    onselectmarkup?: (item: MarkupShapeOption) => void;
    onremovemarkup?: (item: MarkupShapeOption) => void;
    onaddmarkup?: (item: MarkupShapeOption) => void;

    stickers?: Sticker[];
    afterUpdateStickerItem?: (button: HTMLButtonElement, item: { index: number, sticker: Sticker}) => void; 

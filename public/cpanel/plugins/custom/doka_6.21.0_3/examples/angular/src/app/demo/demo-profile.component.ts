  ...
  template: `
    ...
    <div class="demo-profile">
        ...
        <lib-doka-overlay
            ...
            <input *ngIf="!bannerEnabled" type="file" accept="image/*" (change)="handleFileChangeBanner($event)"/>
            <img [src]="bannerPreviewSrc" alt=""/>
        </lib-doka-overlay>

        <div class="profile">
            <button *ngIf="!profileEnabled" (click)="handleToggleProfileEditor()">Edit</button>
            <input *ngIf="!profileEnabled" type="file" accept="image/*" (change)="handleFileChangeProfile($event)"/>
